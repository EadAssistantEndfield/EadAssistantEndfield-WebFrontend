...
import { type ParsedBlueprintNodeInput } from '@/features/blueprint/domain/parser/blueprintParser'
import { getBuildingMetadata } from '@/features/blueprint/domain/catalog/buildingCatalog'
import { resolvePathPoints, summarizePath, transportCardinalFromDirection } from '@/features/blueprint/domain/path/blueprintPath'
import { resolveTemplateAnchorOffset } from '@/features/blueprint/domain/template/templateAnchorRegistry'
import {
...
} from '@/features/blueprint/domain/template/templateConnectionRegistry'
import {
  toSafeNumber,
  detectAdjacentSide,
