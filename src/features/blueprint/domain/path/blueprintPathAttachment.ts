...
import { detectAdjacentSide, isPointOnCenterlineForSide } from '@/features/blueprint/domain/geometry'
import {
...
import type { PixelPoint } from '@/features/blueprint/domain/path/blueprintPathGeometry'
